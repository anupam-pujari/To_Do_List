  ...
  return (
    <div className="landing-container">
      ...
      <section className="about">
        <h2>About Us</h2>
        <p>
          TodoList is a leading task management tool that helps you stay
          organized and productive. Whether you're managing personal projects or
          collaborating with a team, TodoList has the features you need to
          succeed.
        </p>
      </section>
      ...
      <section className="contact">
        ...
        <p>
          ...
          <a href="mailto:p.anuapm2004@gmail.com">p.anuapm2004@gmail.com</a>.
        </p>
      </section>
    </div>
  );
